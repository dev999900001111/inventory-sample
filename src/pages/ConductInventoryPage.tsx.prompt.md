...
## Screen name
Conduct Inventory Page

## Description
The Conduct Inventory Page allows the user to conduct an inventory count for all items in the inventory. The user can enter the actual quantity of each item and submit the count. The page also displays the date and time of the inventory count.

## Screen layout
The Conduct Inventory Page will have a header, side navigation, and footer. The main content area will have a form for conducting the inventory count.

## Screen behavior
When the Conduct Inventory Page loads, the user will see a form with a table displaying all items in the inventory. The table will have columns for Item Name, Description, Quantity, and Actual Quantity. The user can enter the actual quantity for each item in the Actual Quantity column. The user can submit the inventory count by clicking the "Submit" button at the bottom of the form.

## Input Form
The Conduct Inventory Page form will have the following input fields:
- Actual Quantity (number)

## Error messages
If the user tries to submit the form without entering the actual quantity for all items, an error message will be displayed asking the user to enter the actual quantity for all items.
...
- InventoryService: conductInventory(inventoryCounts: InventoryCount[], date: string, time: string): Promise<void>
## Elements to be used
### React Elements
None
### React Dialogs
...
# prompt
Please carefully review the design information up to this point and create the tsx for the ConductInventoryPage, keeping in mind the division of roles according to the screen list.
Please be sure to inspect the following points before submitting your work.
- Please use Chakra UI to create a polished design.
- Calibrate the screen with only the given components.
- screen should be for Japanese.
- Note the component names (especially the suffixes).
Please respond only to ConductInventoryPage.tsx.
