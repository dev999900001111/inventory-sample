...
## Screen name
Report Inventory Results Page

## Description
The Report Inventory Results Page allows users to view and report any discrepancies found during the inventory verification process. Users can view a list of discrepancies, select the type of discrepancy, and provide a reason for the discrepancy. Once all discrepancies have been reported, users can submit the report.

## Screen layout
The Report Inventory Results Page will consist of a header, side navigation, main content area, and footer. The main content area will be divided into two sections: a list of discrepancies and a form to report discrepancies.

The list of discrepancies will be displayed in a table with the following columns:
- Item Name
- Actual Quantity
- System Quantity
- Discrepancy Type
...
The form to report discrepancies will include the following fields:
- Discrepancy Type (dropdown)
- Reason (text input)
- Submit button

## Screen behavior
When the Report Inventory Results Page is loaded, the list of discrepancies will be retrieved from the InventoryService. The list will be displayed in a table with the option to report a discrepancy for each item.

When a user selects a discrepancy type and provides a reason, the discrepancy will be added to the inventory report. The user can continue to report discrepancies until all discrepancies have been reported. Once all discrepancies have been reported, the user can submit the inventory report.
...
- InventoryService: getInventoryDiscrepancies(), createInventoryReport(inventoryDiscrepancies: InventoryDiscrepancy[]): Promise<InventoryReport>
## Elements to be used
### React Elements
None
### React Dialogs
...
# prompt
Please carefully review the design information up to this point and create the tsx for the ReportInventoryResultsPage, keeping in mind the division of roles according to the screen list.
Please be sure to inspect the following points before submitting your work.
- Please use Chakra UI to create a polished design.
- Calibrate the screen with only the given components.
- screen should be for Japanese.
- Note the component names (especially the suffixes).
Please respond only to ReportInventoryResultsPage.tsx.
