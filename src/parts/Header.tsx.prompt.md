...
## Description
The Header component will be displayed at the top of every page in the inventory management system. It will contain the logo, navigation links, and user profile information.

## Screen layout
The Header will be a horizontal bar that spans the width of the screen. It will be divided into three sections: the logo, navigation links, and user profile information. The logo will be aligned to the left, the navigation links will be centered, and the user profile information will be aligned to the right.

## Screen behavior
The Header will be fixed at the top of the screen and will remain visible as the user scrolls through the page. When the user clicks on a navigation link, the corresponding page will be loaded. When the user hovers over the user profile information, a dropdown menu will appear with options to view the user's profile, log out, or switch to a different user account.
