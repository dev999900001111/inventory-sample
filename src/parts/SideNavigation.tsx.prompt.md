...
## Description
The SideNavigation component is a navigation menu that allows users to easily access different pages within the inventory management system. It is located on the left-hand side of the screen and is always visible.

## Screen layout
The SideNavigation component will consist of a list of links to different pages within the system. Each link will be represented by a button with an icon and text label. The currently active page will be highlighted with a different color.

## Screen behavior
When a user clicks on a link in the SideNavigation, the corresponding page will be loaded in the main content area of the screen. The SideNavigation will remain visible and the active link will be highlighted.
...
Note: The SideNavigation component will not directly call any service classes or methods. Its functionality will be handled by the parent component, DashboardPage, which will pass the necessary props to the SideNavigation component.
## Elements to be used
### React Elements
None
### React Dialogs
...
# prompt
Please carefully review the design information up to this point and create the tsx for the SideNavigation, keeping in mind the division of roles according to the screen list.
Please be sure to inspect the following points before submitting your work.
- Please use Chakra UI to create a polished design.
- Calibrate the screen with only the given components.
- screen should be for Japanese.
- Note the component names (especially the suffixes).
Please respond only to SideNavigation.tsx.
